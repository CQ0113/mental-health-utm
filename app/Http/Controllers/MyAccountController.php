...
class MyAccountController extends Controller
{
     ...
     * rest of the tabs (study/marriage/health) keep their existing static
     * content since there is no schema backing for them.
     *
     * The Confirmation/Pengesahan tab is real as of Phase 3: DC01 View
     * Declaration Form is served from here alongside the profile it
     * declares, since it's a tab on this page rather than a page of its own.
     */
    public function show(Request $request): Response
    {
        ...
        return Inertia::render('psycare/perkhidmatan', [
            ...
            'myDeclaration' => $client
                ? $this->declarations->present($this->declarations->forClient($client))
                : null,
            'declarationText' => config('psycare.declaration.text'),
        ]);
    }
}
